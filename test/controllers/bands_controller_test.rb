...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { band_members: @band.band_members, description: @band.description, rating: @band.rating, title: @band.title }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { band_members: @band.band_members, description: @band.description, rating: @band.rating, title: @band.title }
    assert_redirected_to band_path(assigns(:band))
  end
